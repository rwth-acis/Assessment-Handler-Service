...
public class ServiceTest {
		...
		private static final String mainPath = "Assessment/";
		...
		public void startServer() throws Exception {
			...
			node.startService(new ServiceNameVersion(AssessmentHandlerService.class.getName(), "1.0.0"), "a pass");
		...
		public void testAssessment() {
			...
			try {
				...
				ClientResponse result = client.sendRequest("POST", mainPath + "assessment", "{}", MediaType.TEXT_PLAIN, MediaType.TEXT_PLAIN, new HashMap<>());
				Assert.assertEquals(200, result.getHttpCode());
				Assert.assertEquals("test", result.getResponse().trim());// YOUR RESULT VALUE HERE
