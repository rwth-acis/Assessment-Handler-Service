...
set L2P_JAR_PATH="%BASE%/lib/las2peer-bundle-1.2.4.jar"

java -cp %CLASSPATH% -jar %L2P_JAR_PATH% --port 9011 --service-directory service uploadStartupDirectory startService('i5.las2peer.services.AssessmentHandler.AssessmentHandlerService@1.0.0','assess') startWebConnector interactive
pause
